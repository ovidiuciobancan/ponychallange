...
namespace PonyChallange.Utils.Collections {
	...
	public class PriorityQueue<T> : PriorityQueue
	{
		public new T Dequeue() => (T)base.Dequeue();
		public void Enqueue(T value, IComparable priority) => base.Enqueue(value, priority);
	}
